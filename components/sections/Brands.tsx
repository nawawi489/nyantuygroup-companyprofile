          ...
          return (
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col relative">
                 {/* Icon Badge */}
                <div className={`w-14 h-14 ${brand.color.replace('bg-', 'bg-')} rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg transform -translate-y-16 border-4 border-white group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                  <BrandIcon size={28} />
                </div>

                <h4 className="font-display font-bold text-2xl leading-snug text-brand-dark mb-3 -mt-8">{brand.name}</h4>
                <p className="text-gray-600 leading-relaxed mb-8 flex-1">{brand.description}</p>
